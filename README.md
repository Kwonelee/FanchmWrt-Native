<div align="center">
  ...
  <img src="https://img.shields.io/github/forks/Kwonelee/FanchmWrt-Native.svg?style=for-the-badge&color=ff69b4"/>
  <img src="https://img.shields.io/github/license/Kwonelee/FanchmWrt-Native.svg?style=for-the-badge&color=blueviolet"/>
...
**FanchmWrt** 是基于OpenWrt深度开发的 **家用防火墙系统** ，集成 **应用过滤功能** ，功能更强大

> [!TIP]
> 📢本项目提供了一个 **将 rockchip 设备适配至 FanchmWrt 项目源码** 的参考实现，支持通过源码编译生成 **`sysupgrade`** 格式固件。该格式支持手动在线刷写升级， **一次适配，持续更新** ，无需重复刷机
...
- [fanchmwrt](https://github.com/fanchmwrt) ； [QiuSimons](https://github.com/QiuSimons/YAOF) ； [openwrt-packages](https://github.com/Kwonelee/openwrt-packages)
